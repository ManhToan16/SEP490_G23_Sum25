...
{
    [TestFixture]
    public class UpdateExaminationRoomTests
    {
        ...
        public async Task Update_ValidUpdate_ReturnsUpdatedRoom()
        {
            ...
            var existingRoom = new ExaminationRoom { Id = id, Name = "Phòng cũ", Description = "Mô tả cũ" };
            var request = new UpdateExaminationRoomDTO { Name = "Phòng mới", Description = "Mô tả mới" };

            _roomRepositoryMock
                .Setup(r => r.FindByIdAsync(id))
                .ReturnsAsync(existingRoom);
            _roomRepositoryMock
                .Setup(r => r.UpdateAsync(It.IsAny<ExaminationRoom>()))
            ...
            _roomRepositoryMock.Verify(r => r.UpdateAsync(It.Is<ExaminationRoom>(
        ...
        public async Task Update_PartialUpdateWithNullFields_ReturnsUpdatedRoom()
        {
            var id = Guid.NewGuid().ToString();
            var existingRoom = new ExaminationRoom { Id = id, Name = "Phòng cũ", Description = "Mô tả cũ" };
            var request = new UpdateExaminationRoomDTO { Name = "Phòng mới", Description = null };
        ...
        public async Task Update_NameExactly100Chars_ReturnsSuccess()
        {
            var id = Guid.NewGuid().ToString();
            var existingRoom = new ExaminationRoom { Id = id, Name = "Phòng cũ", Description = "Mô tả cũ" };
            var request = new UpdateExaminationRoomDTO { Name = new string('A', 100), Description = "Mô tả mới" };
        ...
        public void Update_NonExistentRoom_ThrowsResourceNotFoundException()
        {
            ...
            _roomRepositoryMock.Verify(r => r.FindByIdAsync(id), Times.Once());
            _roomRepositoryMock.Verify(r => r.UpdateAsync(It.IsAny<ExaminationRoom>()), Times.Never());
        ...
        public void Update_NameOver100Chars_FailsValidation()
        {
            var id = Guid.NewGuid().ToString();
            var existingRoom = new ExaminationRoom { Id = id, Name = "Phòng cũ", Description = "Mô tả cũ" };
            var request = new UpdateExaminationRoomDTO { Name = new string('A', 101), Description = "Mô tả mới" };
        ...
        public void Update_DescriptionOver200Chars_FailsValidation()
        {
            var id = Guid.NewGuid().ToString();
            var existingRoom = new ExaminationRoom { Id = id, Name = "Phòng cũ", Description = "Mô tả cũ" };
            var request = new UpdateExaminationRoomDTO { Name = "Phòng mới", Description = new string('D', 201) };
        ...
        public async Task Update_UpdateAsyncFails_RollsBackTransaction()
        {
            ...
            _roomRepositoryMock.Verify(r => r.FindByIdAsync(id), Times.Once());
            _roomRepositoryMock.Verify(r => r.UpdateAsync(It.IsAny<ExaminationRoom>()), Times.Once());
            _contextMock.Verify(c => c.SaveChangesAsync(It.IsAny<CancellationToken>()), Times.Never());
            _databaseMock.Verify(d => d.BeginTransactionAsync(It.IsAny<CancellationToken>()), Times.Once());
            _transactionMock.Verify(t => t.CommitAsync(It.IsAny<CancellationToken>()), Times.Never());
        ...
        public async Task Update_RoomNameAlreadyExists_ThrowsInvalidOperationException()
        {
            var id = Guid.NewGuid().ToString();
            var existingRoom = new ExaminationRoom { Id = id, Name = "Phòng cũ", Description = "Mô tả cũ" };
            var request = new UpdateExaminationRoomDTO { Name = "Phòng đã tồn tại", Description = "Mô tả mới" };
